...
marks_sub <- spatstat.core::subset.ppp(shar::species_a, select = dbh)
...
testthat::test_that("All errors are returned for reconstruct_pattern_marks", {
  ...
  testthat::expect_error(shar::reconstruct_pattern_marks(pattern = spatstat.core::unmark(shar::species_b),
                                                         marked_pattern = marks_sub,
                                                         n_random = 3,
                                                         max_runs = 1,
                                                         verbose = FALSE),
  ...
  testthat::expect_error(shar::reconstruct_pattern_marks(pattern = pattern_recon,
                                                         marked_pattern = spatstat.core::subset.ppp(shar::species_a,
                                                                                               select = status),
