...
# no input
marks_recon_ni <- shar::reconstruct_marks(pattern = pattern_recon,
                                          marked_pattern = marks_sub,
                                          n_random = 3,
                                          max_runs = 1,
                                          return_input = FALSE,
...
# simplify = TRUE
marks_recon_simple <- shar::reconstruct_marks(pattern = pattern_recon,
                                              marked_pattern = marks_sub,
                                              n_random = 1,
                                              max_runs = 1,
                                              return_input = FALSE,
...
#
#   testthat::expect_true(all(energy < 0.1))
# })
