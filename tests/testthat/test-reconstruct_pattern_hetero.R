...
pattern_recon_ni <- shar::reconstruct_pattern_hetero(pattern = input_pattern,
                                                     n_random = 2,
                                                     max_runs = 1,
                                                     return_input = FALSE,
                                                     verbose = FALSE)

pattern_recon_comp_fast <- shar::reconstruct_pattern_hetero(pattern = input_pattern,
                                                            n_random = 1,
                                                            max_runs = 1,
                                                            comp_fast = 0,
                                                            verbose = FALSE)

pattern_recon_energy <- shar::reconstruct_pattern_hetero(pattern = input_pattern,
                                                         e_threshold = 0.1,
                                                         n_random = 3,
                                                         verbose = FALSE)

pattern_recon_simple <- shar::reconstruct_pattern_hetero(pattern = input_pattern,
                                                         n_random = 1,
                                                         max_runs = 1,
                                                         return_input = FALSE,
                                                         simplify = TRUE,
...
testthat::test_that("Output is a long as n_random for reconstruct_pattern_hetero", {
...
testthat::test_that("Output includes randomizations and original pattern for reconstruct_pattern_hetero", {
...
testthat::test_that("Reconstructed patterns have same number of points", {
  ...
  testthat::expect_true(all(vapply(pattern_recon$randomized,
                                   FUN.VALUE = logical(1),
                                   function(x) x$n == input_pattern$n)))
})

testthat::test_that("Input pattern can not be returned for reconstruct_pattern_hetero", {
...
testthat::test_that("simplify works for reconstruct_pattern_hetero", {

  testthat::expect_is(pattern_recon_simple, "ppp")
})

testthat::test_that("reconstruct_pattern_hetero returns error if n_random < 1", {

  testthat::expect_error(shar::reconstruct_pattern_hetero(pattern = input_pattern,
                                                          n_random = -5,
                                                          verbose = FALSE),
...
testthat::test_that("reconstruct_pattern_hetero returns error if weights are wrong ", {
...
testthat::test_that("reconstruct_pattern_hetero returns warnings", {

  testthat::expect_warning(shar::reconstruct_pattern_hetero(pattern = input_pattern,
                                                            n_random = 2,
                                                            max_runs = 1,
                                                            return_input = FALSE,
                                                            simplify = TRUE),
