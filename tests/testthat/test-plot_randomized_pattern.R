...
testthat::test_that("plot_randomized_pattern returns plot", {
  ...
  testthat::expect_null(plot_randomized_pattern(pattern_random, verbose = FALSE,
                                                ask = FALSE))

  testthat::expect_null(plot_randomized_pattern(pattern_random, what = "pp",
                                                verbose = FALSE,
                                                ask = FALSE))
})
...
testthat::test_that("plot_randomized_pattern returns error if observed is missing", {
  ...
  testthat::expect_error(plot_randomized_pattern(pattern_random_ni, verbose = FALSE),
...
testthat::test_that("plot_randomized_pattern uses comp_fast", {
  ...
  testthat::expect_null(plot_randomized_pattern(pattern_random, comp_fast = 50,
                                                verbose = FALSE, ask = FALSE))
})

testthat::test_that("plot_randomized_patterns works for reconstructed marks", {

  testthat::expect_null(plot_randomized_pattern(marks_recon, verbose = FALSE))
})

testthat::test_that("plot_randomized_patterns returns error if what is wrong", {

  testthat::expect_error(plot_randomized_pattern(pattern_random, what = "wrong",
                                                 verbose = FALSE),
...
testthat::test_that("plot_randomized_patterns returns error if wrong class ", {
  ...
  testthat::expect_error(plot_randomized_pattern(list(species_a, species_b),
                                                 verbose = FALSE),
