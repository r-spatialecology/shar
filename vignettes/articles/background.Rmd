...
knitr::include_graphics("../man/figures/methods_overview.png")
```
...
knitr::include_graphics("../man/figures/random_walk.gif")
```
...
knitr::include_graphics("../man/figures/gamma_vs_reconstruction.png")
```
...
knitr::include_graphics("../man/figures/pattern_reconstruction.gif")
```
