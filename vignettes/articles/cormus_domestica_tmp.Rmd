...
The vignettes of this package require the `getCRUCLdata` package, which is not available on CRAN anymore. To install the package, please run `install.packages('getCRUCLdata', repos = 'http://packages.ropensci.org', typ = 'source')`.
