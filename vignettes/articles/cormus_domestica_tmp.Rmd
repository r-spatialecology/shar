...
# Re-project raster
tmp_raster_jun_eur_3395 <- raster::projectRaster(tmp_raster_jun_eur, crs = "EPSG:3395")
...
```{r land_plots, echo=FALSE, message=FALSE, warning=FALSE, fig.retina=FALSE, out.width="100%", dpi=400, fig.cap="Figure 1 - The mean temperature in June over the 1961-1990 period on a continuous scale (left) and classified in to ten discrete categories (right)."}
...
```{r result_plot, echo=FALSE, message=FALSE, warning=FALSE, fig.retina=FALSE, out.width="100%", dpi=400, fig.cap="Figure 3 - The climatic niche of Cormus domestica, as defined by a positive association with a mean June temperature of 15C - 20C."}
...
landscape_classified_results <- raster::reclassify(x = landscape_classified$raster, rcl = rclmat)
...
are mostly restricted to the associated habitat as defined by a mean June 
temperature of 15C - 20C.
However, Cormus domestica does not exist in all areas experiencing a mean June 
temperature of 15C - 20C, highlighting the need to assess further environmental
variables in order to identify the multiple conditions which constitute its niche.
