...
# Crop tmp raster
tmp_raster_eur <- terra::crop(x = tmp_raster,
                              y = roi)

# Re-project raster
tmp_raster_eur_3395 <- raster::projectRaster(tmp_raster_eur, crs = "EPSG:3395")
...
outside these areas, highlighting the need for further analysis
to identify the multiple conditions which constitute the climatic niche of Cormus domestica.
