...
All functions are designed for discrete habitat classes. Following, in case only continuous data is available, this has to be classified to discrete classes. `classify_habitats` provides several ways to classify the data such as the Jenks-Caspall algorithm (Jenks & Caspall 1971)
...
```{r randomize_raster, message = FALSE}
...
```{r randomize_pp, message = FALSE, warning = FALSE}
