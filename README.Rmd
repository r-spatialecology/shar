...
You can find more information and help using the corresponding [homepage](https://r-spatialecology.github.io/shar/index.html).
...
This also automatically installs all non-base `R` package dependencies, namely the following packages: `classInt`, `raster`, `spatstat.explore`, `spatstat.model`, `spatstat.geom`.

## How to use **shar**

Please refer to `vignette("Get started")` to get an introduction to **shar**.
