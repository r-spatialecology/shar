...
#' include Dk, K, Hs, pcf.
#' @param bw,divisor,kernel_arg,rmax Several parameters related to summary function.
#'
#' @details
...
#'
#' @keywords internal
compute_statistics <- function(x, y, k, xr, yr, w_statistics, bw, divisor, kernel_arg, rmax) {
