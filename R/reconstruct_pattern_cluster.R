...
#'
#' @description Pattern reconstruction for clustered patterns
#'
#' @param pattern ppp.
...
#' algorithm starts with a random but clustered pattern, shifts a point to a new location and
...
#' }
#'
#' @aliases reconstruct_pattern_cluster
#' @rdname reconstruct_pattern_cluster
#'
#' @references
...
reconstruct_pattern_cluster <- function(pattern,
  ...
  reconstruction <- list(randomized = result_list,
                         observed = pattern,
                         method = "reconstruct_pattern_cluster()",
